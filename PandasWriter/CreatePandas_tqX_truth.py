...
tqX.feature_names += ["index_x1","index_x2","DRreco_x1x2","DRtruth_x1x2","DRtruth_qX","DRtruth_topX"]
tqX.feature_names += ["reco_top_pt","reco_top_DR","reco_top_m"]
tqX.feature_names += ["reco_X_pt","reco_X_DR","reco_X_m"]
tqX.feature_names += ["reco_x1_pt","reco_x1_DR","reco_x1_m","reco_x1_btag","reco_x2_pt","reco_x2_DR","reco_x2_m","reco_x2_btag"]
#tqX.feature_names += ["reco_q_pt","reco_q_DR","reco_q_m","reco_q_btag"]
tqX.feature_names += ["truth_top_pt","truth_top_m","truth_X_pt","truth_X_m"]
tqX.feature_names += ["truth_x1_pt","truth_x1_m","truth_x1_pdgid","truth_x2_pt","truth_x2_m","truth_x2_pdgid"]
tqX.feature_names += ["truth_q_pt","truth_q_m","truth_q_pdgid"]
tqX.feature_names += ["Wlep_pt","Wlep_eta","Wlep_phi","Wlep_m"]
#["index_q","DRreco_qX","DRreco_topX"]
...
print(tqX.df_mc.columns.unique())
tqX.df_mc.to_feather("pandas_tqXtruth_v2.feather")
