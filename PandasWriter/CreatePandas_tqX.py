...
configfile = 'pandasconfig_tqX_eval.json'
tqX = tqXAnalysis()
...
tqX.feature_names+=["mb1b2","mb1b3","mb2b3"]
tqX.feature_names+=["mbb_leading_bjets","mbb_maxdr","mbb_mindr","m_jj_leading_jets","jets_n","bjets_n","dRmin_bb","dRmax_bb","dRavg_bb","pt_mbbdRmin","pt_mbbdRmax","pt_mbbleadb"]
...
samples+=["Data","ttb","ttc","ttbarlight","Wtocb","Singletop","topEW","ttH","Wjets","Zjets","Dibosons","tH"]
tqX.readData(samples=samples)
tqX.df_mc.reset_index(inplace=True)
tqX.df_mc.to_feather("pandas_tqXv7.feather")
